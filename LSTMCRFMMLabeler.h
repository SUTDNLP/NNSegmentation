...
#include "N3L.h"
#include "basic/LSTMCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  LSTMCRFMMClassifier<gpu> m_classifier;
#else
  LSTMCRFMMClassifier<cpu> m_classifier;
#endif
...
public:
  void train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile, const string& wordEmbFile, const string& tagEmbFile);
