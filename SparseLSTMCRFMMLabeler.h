...
#include "N3L.h"
#include "basic/SparseLSTMCRFMMClassifier.h"
#include "Options.h"
#include "Instance.h"
#include "Example.h"
...
#if USE_CUDA==1
  SparseLSTMCRFMMClassifier<gpu> m_classifier;
#else
  SparseLSTMCRFMMClassifier<cpu> m_classifier;
#endif

public:
  void readWordEmbeddings(const string& inFile, Alphabet& alphabet, NRMat<dtype>& wordEmb, bool needNormalized=true);
...
public:
  void train(const string& trainFile, const string& devFile, const string& testFile, const string& modelFile, const string& optionFile, const string& wordEmbFile, const string& tagEmbFilelist);
