/*
 * RNNCRFMMClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_RNNCRFMMClassifier_H_
#define SRC_RNNCRFMMClassifier_H_
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, int wordcontext, const NRVec<NRMat<dtype> >& tagEmbs, int labelSize, int rnnhiddensize, int hiddensize) {
...
#endif /* SRC_RNNCRFMMClassifier_H_ */
