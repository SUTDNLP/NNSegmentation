/*
 * SparseGRNNCRFMLClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_SparseGRNNCRFMLClassifier_H_
#define SRC_SparseGRNNCRFMLClassifier_H_
...
class SparseGRNNCRFMLClassifier {
public:
  SparseGRNNCRFMLClassifier() {
    _dropOut = 0.5;
  }
  ~SparseGRNNCRFMLClassifier() {
...
public:
  ...
  inline void init(const NRMat<dtype>& wordEmb, int wordcontext, const NRVec<NRMat<dtype> >& tagEmbs, int labelSize,
      int grnnhiddensize, int hiddensize, int linearfeatSize) {
...
#endif /* SRC_SparseGRNNCRFMLClassifier_H_ */
