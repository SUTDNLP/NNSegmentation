/*
 * SparseGRNNClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_SparseGRNNClassifier_H_
#define SRC_SparseGRNNClassifier_H_
...
class SparseGRNNClassifier {
public:
  SparseGRNNClassifier() {
    _dropOut = 0.5;
  }
  ~SparseGRNNClassifier() {
...
#endif /* SRC_SparseGRNNClassifier_H_ */
