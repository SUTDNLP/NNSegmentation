/*
 * SparseGatedCRFMLClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_SparseGatedCRFMLClassifier_H_
#define SRC_SparseGatedCRFMLClassifier_H_
...
class SparseGatedCRFMLClassifier {
public:
  SparseGatedCRFMLClassifier() {
    _dropOut = 0.5;
  }
  ~SparseGatedCRFMLClassifier() {
...
#endif /* SRC_SparseGatedCRFMLClassifier_H_ */
