/*
 * SparseLSTMCRFMMClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_SparseLSTMCRFMMClassifier_H_
#define SRC_SparseLSTMCRFMMClassifier_H_
...
class SparseLSTMCRFMMClassifier {
public:
  SparseLSTMCRFMMClassifier() {
    _dropOut = 0.5;
  }
  ~SparseLSTMCRFMMClassifier() {
...
#endif /* SRC_SparseLSTMCRFMMClassifier_H_ */
