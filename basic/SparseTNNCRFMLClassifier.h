/*
 * SparseTNNCRFMLClassifier.h
 *
 *  Created on: Mar 18, 2015
 *      Author: mszhang
 */

#ifndef SRC_SparseTNNCRFMLClassifier_H_
#define SRC_SparseTNNCRFMLClassifier_H_
...
class SparseTNNCRFMLClassifier {
public:
  SparseTNNCRFMLClassifier() {
    _dropOut = 0.5;
  }
  ~SparseTNNCRFMLClassifier() {
...
#endif /* SRC_SparseTNNCRFMLClassifier_H_ */
